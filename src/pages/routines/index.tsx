...
const Index = () => {
  ...
  const getPopularRoutines = () => {
    axios
      .get(`${process.env.NEXT_PUBLIC_API_URL}/v1/routine/getPopularRoutines`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      })
  ...
  const onAddExercise = async (routine: IRoutine) => {
    console.log(routine)
    axios
      .post(`${process.env.NEXT_PUBLIC_API_URL}/v1/routine/add`, routine, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      })
  ...
  const onDelete = async (id: number) => {
    axios
      .get(`${process.env.NEXT_PUBLIC_API_URL}/v1/routine/${id}/delete`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      })
