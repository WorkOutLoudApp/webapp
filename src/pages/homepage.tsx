...
const Homepage = () => {
  ...
  const getPosts = () => {
    axios
        .get(`${process.env.NEXT_PUBLIC_API_URL}/v1/post/getPosts`, {
          headers: {
  ...
  const addPost = (description: string) => {
    axios
        .post(`${process.env.NEXT_PUBLIC_API_URL}/v1/post/add`, {
          description,
            linkedRoutine,
        },{
          headers: {
    ...
    const deletePost = (postId: number) => {
        axios
            .post(`${process.env.NEXT_PUBLIC_API_URL}/v1/post/${postId}/delete`, {},{
                headers: {
                    Authorization: `Bearer ${token}`,
                },
            }).then((res) => {
    ...
    const likePost = (postId: number) => {
        axios
            .post(`${process.env.NEXT_PUBLIC_API_URL}/v1/post/${postId}/like`,{}, {
                headers: {
                    Authorization: `Bearer ${token}`,
                },
            }).then((res) => {
    ...
    const getRoutines = () => {
        axios
            .get(`${process.env.NEXT_PUBLIC_API_URL}/v1/routine/getRoutines`, {
                headers: {
                    Authorization: `Bearer ${token}`,
                },
            })
